...
// 请求方式
// 参数信息
function httpSvc(url, method, data, apiType) {var baseURL = apiType == '1' ? 'https://v1.alapi.cn/api' : 'https://v2.alapi.cn/api';_index.default.commit('loadShow', true);return new Promise(function (resolve, reject) {
    uni.request({
      url: baseURL + url,
      method: method,
      data: data,
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.newDetails = exports.tableList = void 0;var _httpSvc = __webpack_require__(/*! ./httpSvc.js */ 40);
// 获取新闻列表
var tableList = function tableList(params) {return (0, _httpSvc.httpSvc)('/zhihu/latest', 'POST', params, '1');};
// 获取新闻详情信息
exports.tableList = tableList;var newDetails = function newDetails(params) {return (0, _httpSvc.httpSvc)('/zhihu/news', 'POST', params, '1');};exports.newDetails = newDetails;
